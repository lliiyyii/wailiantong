...
public class CameraHouseTopRectView extends View {
...
//    private static final int BOTTOM_BTN_HEIGHT = Constant.RECT_VIEW_BOTTOM;
    ...
    private static final String TIPS = "请将户口本信息放入到方框中";
    ...
    public CameraHouseTopRectView(Context context, AttributeSet attrs) {
        super(context, attrs);
 ...
 */
        rectHeght = (int) (rectWidth * 1 / 0.95);
        // 相对于此view
...
//                linePaint);
        ...
        canvas.drawLine(rectLeft, rectTop+(((rectBottom - rectTop)/6)*1), rectRight, rectTop+(((rectBottom - rectTop)/6)*1),
                linePaint);
        canvas.drawLine(rectLeft, rectTop+(((rectBottom - rectTop)/6)*2), rectRight, rectTop+(((rectBottom - rectTop)/6)*2),
                linePaint);
        canvas.drawLine(rectLeft, rectTop+(((rectBottom - rectTop)/6)*3), rectRight, rectTop+(((rectBottom - rectTop)/6)*3),
                linePaint);
        canvas.drawLine(rectLeft, rectTop+(((rectBottom - rectTop)/6)*4), rectRight, rectTop+(((rectBottom - rectTop)/6)*4),
                linePaint);
        canvas.drawLine(rectLeft, rectTop+(((rectBottom - rectTop)/6)*5), rectRight, rectTop+(((rectBottom - rectTop)/6)*5),
                linePaint);
