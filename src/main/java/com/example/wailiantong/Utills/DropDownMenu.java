...
public class DropDownMenu extends LinearLayout {
    ...
    public DropDownMenu(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        underLine.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, dpTpPx(0.8f)));
    ...
    public void setTabText(String text) {
        if (current_tab_position != -1) {
            ...
            Logger.i("打印位置",current_tab_position+"          444");
        }
    }
    public void initText(String textFirst,String textSecond){
        if (current_tab_position != -1) {
            switch (current_tab_position){
                case 0:
                    ((TextView) tabMenuView.getChildAt(2)).setText(textFirst);
                    ((TextView) tabMenuView.getChildAt(4)).setText(textSecond);
                    break;
                case 2:
                    ((TextView) tabMenuView.getChildAt(0)).setText(textFirst);
                    ((TextView) tabMenuView.getChildAt(4)).setText(textSecond);
                    break;
                case 4:
                    ((TextView) tabMenuView.getChildAt(0)).setText(textFirst);
                    ((TextView) tabMenuView.getChildAt(2)).setText(textSecond);
            }
