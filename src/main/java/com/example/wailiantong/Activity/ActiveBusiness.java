...
import com.example.wailiantong.CameraView.CameraBusinessSurfaceView;
...
public class ActiveBusiness extends AppCompatActivity {

    private ImageView takePic;
    private CameraBusinessSurfaceView mCameraSurfaceView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.zsy_camera_business_layout);

        mCameraSurfaceView = (CameraBusinessSurfaceView) findViewById(R.id.business_cameraSurfaceView);
        takePic = (ImageView) findViewById(R.id.business_takePic);
        viewAll= (ImageView) findViewById(R.id.business_camera_viewall);
        numText= (TextView) findViewById(R.id.business_camera_num);
        cancel= (ImageView) findViewById(R.id.business_camera_cancel);
        ...
        viewAll.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent viewAllIntent = new Intent(ActiveBusiness.this,BrowserMain.class);
