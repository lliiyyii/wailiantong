...
package com.example.wailiantong.AliTest.demo;
    ...
    public void sendHttpPostBytes(View view) {
        ...
        Runnable runnable = new Runnable(){
            ...
            public void run() {
                ...
                String imgBase64 = bitmaptoString(BitmapFactory.decodeResource(getResources(), R.drawable.gongzhengchuicon96));
                // 拼装请求body的json字符串
                ...
                Log.w("11111111111111111",content);
