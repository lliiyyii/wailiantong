...
package com.example.wailiantong.AliTest.client;

import android.util.Base64;

import com.example.wailiantong.AliTest.client.constant.Constants;
import com.example.wailiantong.AliTest.client.constant.ContentType;
import com.example.wailiantong.AliTest.client.constant.HttpHeader;
import com.example.wailiantong.AliTest.client.constant.HttpMethod;
import com.example.wailiantong.AliTest.client.constant.HttpSchema;
import com.example.wailiantong.AliTest.client.constant.SystemHeader;
...
public class HttpUtil {
    ...
    public void httpPostBytes(String path , Map<String , String> pathParams , Map<String , String> queryParams , byte[] body , Map<String , String> headerParams , Callback callback)
    {
        ...
        Logger.i("进入了发送","进入了发送");
        Call call = client.newCall(request);
        try {
            Response respnose = call.execute();
            com.example.wailiantong.Utills.Logger.i("这是响应的打印",respnose.toString());
            callback.onResponse(call , respnose);
        }
        catch (IOException ex){
            callback.onFailure(call , ex);
    ...
    //修改了传入的URL地址
    public void httpPostBytesToLicense(String path , Map<String , String> pathParams , Map<String , String> queryParams , byte[] body , Map<String , String> headerParams , Callback callback)
    {

        Request request = this.buildHttpRequest(httpSchema , HttpMethod.CLOUDAPI_POST , AppConfiguration.Business_License , path , pathParams , queryParams , null  , body , ContentType.CLOUDAPI_CONTENT_TYPE_STREAM , ContentType.CLOUDAPI_CONTENT_TYPE_JSON , headerParams);
        Call call = client.newCall(request);
        try {
            Response respnose = call.execute();
            callback.onResponse(call , respnose);
    ...
    //修改了传入的URL地址
    public void httpPostBytesToHouse(String path , Map<String , String> pathParams , Map<String , String> queryParams , byte[] body , Map<String , String> headerParams , Callback callback)
    {
        Request request = this.buildHttpRequest(httpSchema , HttpMethod.CLOUDAPI_POST , AppConfiguration.House , path , pathParams , queryParams , null  , body , ContentType.CLOUDAPI_CONTENT_TYPE_STREAM , ContentType.CLOUDAPI_CONTENT_TYPE_JSON , headerParams);
        Call call = client.newCall(request);
        try {
            Response respnose = call.execute();
            callback.onResponse(call , respnose);
